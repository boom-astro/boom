...
#[openapi(
    ...
    paths(
        ...
        routes::catalogs::get_catalog_exports,
        routes::catalogs::download_catalog_export,
        ...
        routes::tasks::get_enrichment_status,
        routes::tasks::accept_enrichment_set,
        routes::tasks::unaccept_enrichment_set,
