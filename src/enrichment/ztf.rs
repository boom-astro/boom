...
pub struct ZtfAlertClassifications {
    ...
    pub acai_b: f32,
    pub btsbot: f32,
    pub cider_img_nuclear: f32,
    pub cider_img_snI: f32,
    pub cider_img_snII: f32,
    pub cider_img_cataclysmic: f32,
    pub cider_photo_snI: f32,
    pub cider_photo_snII: f32,
    pub cider_photo_cataclysmic: f32,
    pub cider_photo_agn: f32,
    pub cider_photo_tde: f32,
}
